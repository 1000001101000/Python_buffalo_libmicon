...
##restrict available displays to just our custome message for now
##still working on how to switch between auto and manual cycling of displays.
test.send_write_cmd(1,libmicon.lcd_set_dispitem,0x20)
test.send_write_cmd(1,libmicon.lcd_set_dispitem_ex,0x00)

#these don't seem to work, I've had it in both modes at some point but am unclear how to switch.
#test.send_write_cmd(0,libmicon.lcd_changemode_button)
#test.send_write_cmd(0,lcd_changemode_auto)
